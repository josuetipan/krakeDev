calcularValorTotal = function(){
    ...
    valorTotal=calcularTotal(valorSubtotal,valorDescuento,x)
    ...
    mostrarTexto("lblResumen","Valor a pagar por "+cantidad+" "+nombreProducto+" con "+porcentajeDescuento+"% de descuento: "+valorTotal)
        /*
            Ejemplo: 
